...
namespace HotelManagement.Booking.Controllers.Api
{
    public class EmployeesController : ApiController
    {
        ...
        [Route("api/Employees/Validation/{username}/{password}")]
        [ResponseType(typeof(Employee))]
        public Employee GetEmployee(string username, string password)
        {
            var employees = db.Employees.First(x => x.Username.ToLower() == username.ToLower() && x.PasswordHash.ToLower() == password.ToLower());
            return employees;
        }
